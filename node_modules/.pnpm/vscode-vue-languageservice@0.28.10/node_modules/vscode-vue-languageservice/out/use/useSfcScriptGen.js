...
function useSfcScriptGen(lsType, vueUri, vueDoc, script, scriptSetup, scriptRanges, scriptSetupRanges, sfcTemplateCompileResult, sfcStyles, isVue2) {
    ...
    const codeGen = (0, reactivity_1.computed)(() => (0, script_1.generate)(lsType, vueUri, script.value, scriptSetup.value, scriptRanges.value, scriptSetupRanges.value, () => htmlGen.value, () => sfcStyles.value, isVue2));
