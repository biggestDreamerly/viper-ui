...
function testExpandWithCompletion(syntax, abbrev, expanded, options) {
    it(`should expand ${abbrev} to\n${expanded}`, () => __awaiter(this, void 0, void 0, function* () {
        ...
        const completionList = doComplete(document, position, syntax, options !== null && options !== void 0 ? options : COMPLETE_OPTIONS);
...
function testCountCompletions(syntax, abbrev, expectedNumCompletions) {
    it(`should expand ${abbrev} with ${expectedNumCompletions} completions`, () => __awaiter(this, void 0, void 0, function* () {
        const document = TextDocument.create(`test://test/test.${syntax}`, syntax, 0, abbrev);
        const position = Position.create(0, abbrev.length);
