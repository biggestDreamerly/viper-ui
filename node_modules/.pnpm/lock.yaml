...
devDependencies:
  ...
  vite-plugin-copy: 0.1.6
  vite-plugin-dts: 0.9.6_vite@2.7.6
  vite-plugin-md: 0.11.6_vite@2.7.6
...
packages:
  ...
  /vite-plugin-dts/0.9.6_vite@2.7.6:
    resolution: {integrity: sha512-urZnKLo6l3zLOEmKMpQd8HlvONqEfYuMLAeA5wrbtuTChaBUN/Sj7nl3UlJrrEWBisGA75xs0rLUBLfZLZ+AbQ==}
    engines: {node: '>=12.0.0'}
    peerDependencies:
      vite: '>=2.4.4'
    dependencies:
  ...
  /vite-plugin-md/0.11.6_vite@2.7.6:
    resolution: {integrity: sha512-Qpv6x8ebXV1r/zsNWEOh3KUvVbuS+J2KWMitvS4w7TTkcsEBj9oR6cBcWiZ5neWEwSN9JO+808Zs5Ak49ixUfw==}
    peerDependencies:
      vite: ^2.0.0
    dependencies:
      '@antfu/utils': 0.3.0
